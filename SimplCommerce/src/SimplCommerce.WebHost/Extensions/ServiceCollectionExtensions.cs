...
namespace SimplCommerce.WebHost.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            // 1. ASP.NET Identity (COOKIES – REQUIRED by IdentityServer)
            ...
            // 🔴 CRITICAL: Configure Identity cookies explicitly
            services.ConfigureApplicationCookie(options =>
            {
                options.Cookie.Name = ".SimplCommerce.Identity";
            ...
            // 2. IdentityServer (still COOKIE-based internally)
            ...
            .AddAspNetIdentity<User>() // 👈 THIS binds cookies to IdentityServer
            .AddProfileService<SimplProfileService>()
            .AddDeveloperSigningCredential();

            // 3. External providers (NO defaults here)
